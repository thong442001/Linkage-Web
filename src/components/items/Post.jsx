...
const Post = ({
  ...
  const [menuContext, setMenuContext] = useState(null); // Track which button was clicked ('share' or 'original')
  ...
  const handleMoreClick = (event, context) => {
    ...
    setMenuContext(context); // 'share' or 'original'
  };
  ...
  return (
    <div className={postContainerClass}>
        ...
        <div>
          <div className='header-share'>
            <div className='user-info'>
              <a onClick={() => navigate(`/profile/${post.ID_user._id}`)}>
                <img src={post.ID_user?.avatar} className='avatar' alt='User Avatar' />
              </a>
              <div className='user-details'>
                <a onClick={() => navigate(`/profile/${post.ID_user._id}`)} className='name'>
                  {post.ID_user?.first_name} {post.ID_user?.last_name}
                </a>
                <div className='box-name'>
                  <span className='time'>{timeAgo}</span>
                  <div className='box-status-detail'>{getIcon(post.status)}</div>
                </div>
              </div>
            </div>
            <button
      ...
      {/* Header gốc */}
      <div className={post.type == 'Share' ? 'header-shared' : 'header-original'}>
                  ...
                  <div className='user-info'>
                    ...
                    <div className='user-details'>
                      ...
                      <div className='box-name'>
                        ...
                        <div className='box-status-detail'>{getIcon(post.ID_post_shared?.status)}</div>
                      </div>
                    </div>
                  </div>
                )
          ...
          <div className='footer'>
            {post.post_reactions?.length > 0 ? (
              <div className='footer-reactions'>
                <a onClick={() => setReactionListModalVisible(true)}>
            ...
            <div className='reaction-container'>
              ...
              >
                <div className='reaction-icon-box'>
                  <span>{userReaction ? userReaction.ID_reaction.icon : <FaThumbsUp size={15} />}</span>
              ...
              <div className='share-header'>
                ...
                <div>
                  ...
                  <div className='box-status'>
                    <button className='btn-status' onClick={() => setStatusModalVisible(true)}>
                      {selectedOption.name}
                    </button>
                  </div>
                </div>
        ...
        isImageModalVisible && (
          <div className='mediaOverlay' onClick={() => setImageModalVisible(false)}>
            <div className='fullMediaContainer' onClick={(e) => e.stopPropagation()}>
              <button className='closeButton' onClick={() => setImageModalVisible(false)}>
                ✕
              </button>
...

      {
        reactionListModalVisible && (
          <div className='overlay' onClick={() => setReactionListModalVisible(false)}>
            <div
                  ...
                  {filteredReactions.map((reaction, index) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div>
                          {reaction.ID_reaction.icon} {reaction.ID_reaction.name}
                        </div>
                      </div>
                    </li>
                  ))}
